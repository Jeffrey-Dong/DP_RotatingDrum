...
%    atominfo_datafilename=['E:\RoDrtest\RoDr_alphastart0-1\model' num2str(modelnum(modeli,1)) '\model' num2str(modelnum(modeli,1)) '_clustermethod_' char(clustermethod) '_Angle' num2str(angle_threshold/pi*180) '_dbs_minpts2_strrfilt_avefnfilt_pldistcoe0_00000001.mat'];
   atominfo_datafilename=['E:\RoDrtest\RoDr_alphastart0-1\model' num2str(modelnum(modeli,1)) '\model' num2str(modelnum(modeli,1)) '_clustermethod_' char(clustermethod) '_Angle' num2str(angle_threshold/pi*180) '_dbs_minpts2_strrfilt_5surftendpfilt_.mat'];
   end
