...
% model_number=[119,120,134,121:123]';% w90
% model_number=[124,125,151,126:128]';% w120
model_number=[139,140,152,141:143]';% w150
...
for modeli=1:size(model_number)

    datafile=(['f:\RoDrtest\RoDr_alphastart0-1\model' num2str(model_number(modeli,1))]);
...
%% save contour plot
%     cd('C:\Users\jeffr\Dropbox (Sydney Uni)\projects\unsaturated\Roration drum experiment\Manuscript figures\Sim_strainrate_boundary');
%     saveas(gca,['model' num2str(model_number(modeli)) 'epsilon7_xwsift10.tif']);
%     close figure 2;
