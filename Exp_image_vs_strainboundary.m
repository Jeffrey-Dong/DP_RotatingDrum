...
% filenum=[149,152:154]';%149:154,m=0.02
filenum=[169:172]';%149:154,m=0.02
% filenum=[157,158,161,162]';%149:154,dry
...
for fi=1:size(filenum,1)
    ...
    load([filedir 'C0' num2str(filenum(fi,1)) '\C0' num2str(filenum(fi,1)) '_strr-coe3_strainrate_depth_2.mat']);
    ...
    video = VideoWriter(['c0' num2str(filenum(fi,1)) '_strr-coe3_surf-strr_bound']); %create the video object 
